...
driver.get("https://okky.kr/articles/1373750?keyword=&order=DESC&page=1&from=editors-choice")
...
df.to_csv(r"D:\pythonCrawling\data\crawlingFile\okky\okkyEChoice01.csv",encoding ='utf8',index = False)
